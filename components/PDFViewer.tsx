...
export default function PDFViewer() {
  ...
  return (
    <section ref={containerRef} className="py-12 md:py-24 px-4 md:px-20 bg-[#050505]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          <div className="flex items-center gap-4 mb-4 md:mb-6">
            ...
            <p className="text-[10px] md:text-[11px] uppercase tracking-[0.28em] text-orange-500 font-bold">Official Document</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
            <div className="bg-white/[0.03] border border-white/10 rounded-xl p-3 md:p-4">
              <p className="text-[9px] md:text-[10px] uppercase text-orange-400 mb-1 tracking-wider">Participants</p>
              <p className="text-white text-xl md:text-2xl font-bold">100</p>
              <p className="text-white/50 text-xs md:text-sm">Students</p>
            </div>
            <div className="bg-white/[0.03] border border-white/10 rounded-xl p-3 md:p-4">
              <p className="text-[9px] md:text-[10px] uppercase text-blue-400 mb-1 tracking-wider">Faculty</p>
              <p className="text-white text-xl md:text-2xl font-bold">20</p>
              <p className="text-white/50 text-xs md:text-sm">Scientific Supervisors</p>
            </div>
            <div className="bg-white/[0.03] border border-white/10 rounded-xl p-3 md:p-4">
        ...
        <TiltCard className="rounded-2xl border border-white/10 bg-white/[0.03] overflow-hidden group hover:border-white/20 transition-all">
          ...
          <div className="p-4 md:p-6 border-b border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between bg-black/20 gap-3">
            <div className="flex-1 min-w-0">
              ...
              <p className="mt-1 text-white/80 text-xs md:text-sm font-medium line-clamp-2 sm:line-clamp-1">To: Mr. Viktor Sergeevich Kokushkin, Vice President Go-BRICS Business Forum</p>
            </div>
            
            <button
              onClick={handleExpandToggle}
              className="flex-shrink-0 text-xs uppercase tracking-[0.22em] text-orange-500 hover:text-orange-400 transition flex items-center gap-2 px-3 py-2 rounded-lg bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20"
            >
          ...
          <div className={`bg-white/5 transition-all duration-500 ease-in-out ${
            ...
            <iframe
              src="/russia.pdf#view=FitH&toolbar=0&navpanes=0&scrollbar=1&page=1&zoom=page-fit"
        ...
        <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 md:p-6">
            <h3 className="text-white/90 font-semibold mb-3 text-sm md:text-base">Specialization Areas</h3>
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4 md:p-6">
            <h3 className="text-white/90 font-semibold mb-3 text-sm md:text-base">University Leadership</h3>
            <div className="text-white/60 text-xs md:text-sm">
              <p className="mb-2"><strong className="text-white/80">Rector:</strong> A.A. Dyakonov</p>
              <p className="leading-relaxed"><strong className="text-white/80">Institution:</strong> Almetyevsk State Technological University "Higher School of Oil"</p>
            </div>
          </div>
        </div>
      </div>
